...
export class PlanService 
{
    ...
    public SavePlan(planMasterModel: PlanMasterModel) {
        ...
        headers = headers.append('Authorization', 'Bearer ' + `${this.username}`);
        //console.log(planMasterModel);
    ...
    {
        var apiUrl = "	http://localhost:3000/api/GetTotalAmount/";
    ...
    public GetAllActivePlans(schemeId) {
        var apiUrl = "http://localhost:3000/api/AllActivePlanMaster" + '/' + schemeId;
